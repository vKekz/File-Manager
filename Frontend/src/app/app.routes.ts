...
export const routes: Routes = [
  ...
  { path: APP_ROUTES.login, component: LoginFormComponent, pathMatch: "full", canActivate: [SessionGuard] },
  { path: APP_ROUTES.signup, component: SignupFormComponent, pathMatch: "full", canActivate: [SessionGuard] },
  { path: APP_ROUTES.account, component: AccountComponent, pathMatch: "full", canActivate: [AuthGuard] },
